...
ShipInfo? LookupShip(string name) => ShipReferenceData.LookupShip(ships, name);
...
string[] LinesForMode(string? appMode) => ShipReferenceData.LinesForMode(ships, appMode);
...
// ── Records ─────────────────────────────────────────────────────────────
// ShipInfo record is defined in Data/ShipReferenceData.cs
